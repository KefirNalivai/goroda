...
// Создаем геообъект с типом геометрии "Точка".
    ...
    myMap.geoObjects
        ...
        .add(new ymaps.Placemark([44.618356, 33.524297], {
            balloonContent: 'цвет <strong>Затопленным кораблям</strong>',
            iconCaption: 'Затопленным кораблям'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }))
	
	 .add(new ymaps.Placemark([44.554338, 33.583664], {
            balloonContent: 'цвет <strong>Мемориальный комплекс Сапун-гора</strong>',
            iconCaption: 'Мемориальный комплекс Сапун-гора'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }));
