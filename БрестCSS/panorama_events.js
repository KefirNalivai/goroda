...
// Создаем геообъект с типом геометрии "Точка".
    ...
    myMap.geoObjects
        ...
        .add(new ymaps.Placemark([52.083315, 23.659571], {
            balloonContent: 'цвет <strong>Брестская крепость</strong>',
            iconCaption: 'Брестская крепость'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }))
	
	 .add(new ymaps.Placemark([52.574227, 23.804779], {
            balloonContent: 'цвет <strong>Беловежская Пуща</strong>',
            iconCaption: 'Беловежская Пуща'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }));
