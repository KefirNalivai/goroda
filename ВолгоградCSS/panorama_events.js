...
// Создаем геообъект с типом геометрии "Точка".
    ...
    myMap.geoObjects
        ...
        .add(new ymaps.Placemark([48.805461, 44.607862], {
            balloonContent: 'цвет <strong>Народному ополчению 1941-1945 гг</strong>',
            iconCaption: 'Народному ополчению 1941-1945 гг'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }))
	
	 .add(new ymaps.Placemark([48.7141, 44.5309], {
            balloonContent: 'цвет <strong>«Линия обороны Сталинграда»</strong>',
            iconCaption: '«Линия обороны Сталинграда»'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }))
 .add(new ymaps.Placemark([48.802091, 44.605278], {
            balloonContent: 'цвет <strong>«Танк Т-34 у Тракторного завода»</strong>',
            iconCaption: '«Танк Т-34 у Тракторного завода»'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }));
