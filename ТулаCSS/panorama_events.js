...
// Создаем геообъект с типом геометрии "Точка".
    ...
    myMap.geoObjects
        ...
        .add(new ymaps.Placemark([54.264877, 37.603092], {
            balloonContent: 'цвет <strong>Защитникам неба Отечества</strong>',
            iconCaption: 'Защитникам неба Отечества'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }))
	
	 .add(new ymaps.Placemark([54.181929, 37.607265], {
            balloonContent: 'цвет <strong>Монумент тулякам – Героям Советского Союза</strong>',
            iconCaption: 'Монумент тулякам – Героям Советского Союза'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }));
