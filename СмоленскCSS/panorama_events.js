...
// Создаем геообъект с типом геометрии "Точка".
    ...
    myMap.geoObjects
        ...
        .add(new ymaps.Placemark([54.778866, 32.052104], {
            balloonContent: 'цвет <strong>Опалённый цветок</strong>',
            iconCaption: 'Опалённый цветок'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }))
	
	 .add(new ymaps.Placemark([54.779472, 32.045683], {
            balloonContent: 'цвет <strong>Сквер Памяти Героев</strong>',
            iconCaption: 'Сквер Памяти Героев'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }));
