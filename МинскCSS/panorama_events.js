...
// Создаем геообъект с типом геометрии "Точка".
    ...
    myMap.geoObjects
        ...
        .add(new ymaps.Placemark([53.908676, 27.575086], {
	 ...
	 .add(new ymaps.Placemark([53.915908, 27.538055], {
            balloonContent: 'цвет <strong>Стела Минск – город-герой</strong>',
            iconCaption: 'Стела Минск – город-герой'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }))

	.add(new ymaps.Placemark([53.908592, 27.563661], {
            balloonContent: 'цвет <strong>Памятник Марату Казею</strong>',
            iconCaption: 'Памятник Марату Казею'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }))

	.add(new ymaps.Placemark([53.901640, 27.565024], {
            balloonContent: 'цвет <strong>Танк-памятник у Дома офицеров</strong>',
            iconCaption: 'Танк-памятник у Дома офицеров'
        }, {
            preset: 'islands#greenDotIconWithCaption'
        }))
;
